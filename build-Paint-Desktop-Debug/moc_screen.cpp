...
QT_MOC_LITERAL(1, 7, 7), // "sendLoc"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 3), // "loc"
QT_MOC_LITERAL(4, 20, 8), // "setPixel"
QT_MOC_LITERAL(5, 29, 10), // "incPixSize"
QT_MOC_LITERAL(6, 40, 10), // "decPixSize"
QT_MOC_LITERAL(7, 51, 19), // "changeSetPixelColor"
QT_MOC_LITERAL(8, 71, 11), // "resetScreen"
QT_MOC_LITERAL(9, 83, 6) // "getLoc"

    },
    "Screen\0sendLoc\0\0loc\0setPixel\0incPixSize\0"
    "decPixSize\0changeSetPixelColor\0"
    "resetScreen\0getLoc"
};
...
void Screen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setPixel((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 2: _t->incPixSize(); break;
        case 3: _t->decPixSize(); break;
        case 4: _t->changeSetPixelColor(); break;
        case 5: _t->resetScreen(); break;
        case 6: _t->getLoc((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Screen::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Screen::sendLoc)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Screen::sendLoc(QPoint _t1)
{
